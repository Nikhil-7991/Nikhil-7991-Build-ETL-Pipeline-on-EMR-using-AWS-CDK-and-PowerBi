...
SUBNET_ID ="subnet-0b496178f4effec66"
...
class EMRClusterStack(Stack):
    def __init__(
        ...
        **kwargs,
            ...
            steps=[
                {
                    ...
                    "hadoopJarStep": {
                        ...
                        "args": [
                            "hive",
                            "-f",
                            f"s3://{scripts_location}/create_table.sql",
                        ],
                    },
                    "name": "create_tables",
                },
                {
                    ...
                    "hadoopJarStep": {
                        ...
                        "args": [
                            "hive",
                            "-f",
                            f"s3://{scripts_location}/transform_table.sql",
                        ],
                    },
                    "name": "transform_data",
                }
        ...
        did this code created sales data from transform table